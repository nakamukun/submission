            ...
            <div class="flex justify-between h-16">
                ...
                <div class="-mr-2 flex items-center sm:hidden">
                 ...
                 <x-nav-link :href="route('users/index')" :active="request()->routeIs('index')" class="index">
                    ...
                    <button class="open" @click="open = ! open" class="inline-flex items-center justify-center p-2 rounded-md text-gray-400 hover:text-gray-500 hover:bg-gray-100 focus:outline-none focus:bg-gray-100 focus:text-gray-500 transition duration-150 ease-in-out">
